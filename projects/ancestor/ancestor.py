...
def earliest_ancestor(ancestors, starting_node):
    ...
    # Keep track of # ancestors; highest means most ancestors
    longest_path = 1      
    ...
    for vertex in ancestor_tree.vertices:
        ...
        if path:
            ...
            if len(path) > longest_path:
                ...
                # Set earliest_ancestor equal to current node/vertex  
                earliest_ancestor = vertex 
        # If path is 'None' and 'longest_path' is our default of 1          
